...
const INPUTS = {
  ...
  valet: ['src/app/[locale]/valet', 'src/styles/pages/valet.css', 'src/messages/es/valet.json', 'src/messages/en/valet.json', 'src/messages/es/supporting.json', 'src/messages/en/supporting.json'],
