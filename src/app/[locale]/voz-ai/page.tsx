...
import '@/styles/pages/voz-ai.css';
...
export default function VozAiPage({ params }: { params: { locale: Locale } }) {
  setRequestLocale(params.locale);

  const t = useTranslations('vozAi');
    ...
    <>
      ...
      <JsonLd
        data={breadcrumbSchema(params.locale, [
          ...
          { name: nav('vozAi'), path: routes.vozAi }
        ])}
      />
      <JsonLd
        data={faqSchema(
